...
const getQuizzesForDocument = async (documentId) => {
    try {
        ...
        throw error.response?.data || { message: 'An error occurred while fetching quizzes for document.' };
    }
};
...
const getQuizById = async (quizId) => {
    try {
        ...
        throw error.response?.data || { message: 'An error occurred while fetching quiz.' };
    }
};
...
const submitQuiz = async (quizId, answers) => {
    try {
        ...
        throw error.response?.data || { message: 'An error occurred while submitting quiz.' };
    }
};
...
const getQuizResults = async (quizId) => {
    try {
        ...
        throw error.response?.data || { message: 'An error occurred while fetching quiz results.' };
    }
};
...
const deleteQuiz = async (quizId) => {
    try {
        ...
        throw error.response?.data || { message: 'An error occurred while deleting quiz.' };
    }
};
