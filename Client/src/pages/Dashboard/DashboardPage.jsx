...
const DashboardPage = () => {
  ...
  const flashcardProgress = overview.totalFlashcards > 0 
        ...
        <div className='flex items-center justify-between mb-8'>
          ...
          <div className='flex items-center gap-3'>
            <button
              ...
              className='flex items-center gap-2 px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm font-medium text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition-all duration-200 shadow-sm'
            >
            ...
            <button
              onClick={() => navigate('/documents')}
              className='flex items-center gap-2 px-4 py-2.5 btn-primary text-white rounded-xl text-sm font-semibold shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 transition-all duration-200'
            >
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6'>
          ...
          <div className='card-base p-6'>
            <div className='flex items-center justify-between mb-6'>
              <div>
                <h3 className='text-base font-semibold text-slate-900'>Flashcard Progress</h3>
                <p className='text-xs text-slate-500 mt-0.5'>Cards reviewed vs total</p>
              </div>
              <div className='flex items-center gap-1 px-2.5 py-1 bg-purple-50 rounded-lg'>
                <TrendingUp className='w-3.5 h-3.5 text-purple-600' />
                <span className='text-xs font-semibold text-purple-700'>+{overview.reviewedFlashcards}</span>
              </div>
            </div>
            <div className='flex items-center justify-center'>
              <CircularProgress percentage={flashcardProgress} color="purple" />
            </div>
            <div className='flex items-center justify-center gap-6 mt-6'>
              <div className='flex items-center gap-2'>
                <div className='w-3 h-3 rounded-full bg-purple-500' />
                <span className='text-xs text-slate-600'>Reviewed ({overview.reviewedFlashcards})</span>
              </div>
              <div className='flex items-center gap-2'>
                <div className='w-3 h-3 rounded-full bg-purple-100' />
                <span className='text-xs text-slate-600'>Remaining ({overview.totalFlashcards - overview.reviewedFlashcards})</span>
              </div>
            </div>
          </div>
            ...
            <div className='space-y-4'>
              ...
              <div className='flex items-center justify-between p-3 bg-blue-50/50 border border-blue-100 rounded-xl'>
                <div className='flex items-center gap-3'>
                  ...
                  <div>
                    <p className='text-sm font-semibold text-slate-900'>Cards Mastered</p>
                    <p className='text-xs text-slate-500'>Out of {overview.totalFlashcards} total</p>
                  </div>
                </div>
                <span className='text-2xl font-bold text-blue-600'>{overview.reviewedFlashcards}</span>
              </div>
            </div>
          </div>
        </div>
