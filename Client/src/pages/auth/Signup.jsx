...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen w-full flex justify-center items-center p-4 relative saas-hero-bg text-white overflow-hidden py-10">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="p-7 sm:p-9 rounded-2xl bg-[#0d1322]/90 backdrop-blur-xl border border-white/10 shadow-2xl shadow-black/80">
          ...
          <div className="flex flex-col items-center justify-center text-center mb-6">
            ...
            <p className="text-xs sm:text-sm text-slate-400 mt-1">Start studying 10x faster with your personal AI assistant</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              ...
              {formErrors.name && (
                <p className="text-xs text-rose-400 mt-1">{formErrors.name.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              <div className="text-[11px] text-slate-400 mt-1.5 bg-white/[0.03] p-2.5 rounded-lg border border-white/5">
                <p className="font-semibold text-slate-300 mb-0.5">Password requirements:</p>
                <p className="text-slate-400">Min 8 characters, with 1 uppercase, 1 lowercase, 1 number & 1 special character.</p>
              </div>
            </div>
            ...
            >
              <span>{loading ? "Creating Account..." : "Create Account Free"}</span>
