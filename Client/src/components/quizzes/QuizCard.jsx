...
const QuizCard = ({ quiz, onDelete }) => {
  ...
  return (
    <div className="group relative bg-linear-to-br from-white via-blue-50/30 to-indigo-50/50 backdrop-blur-xl border border-blue-100 hover:border-blue-300 rounded-2xl p-6 flex flex-col justify-between shadow-sm hover:shadow-xl hover:shadow-blue-500/20 transition-all duration-300 h-full overflow-hidden">
      ...
      {/* Actions */}
      <div className="relative mt-6 pt-4 border-t cursor-pointer border-blue-100/60">
        {hasAttempt ? (
          ...
          <Link to={`quizzes/${quiz._id}`} className="block">
            <button className="group/btn cursor-pointer relative w-full h-11 bg-linear-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-semibold text-sm rounded-xl transition-all duration-300 overflow-hidden active:scale-[0.98] shadow-md hover:shadow-lg hover:shadow-blue-500/40">
