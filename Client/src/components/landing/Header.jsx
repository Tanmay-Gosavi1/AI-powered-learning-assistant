      ...
      {isMenuOpen && (
        <div className='lg:hidden absolute top-full left-0 right-0 bg-white border-b border-gray-100 pb-2'>
          <div className='px-2 py-3 space-y-1'>
            <a href="#features" onClick={() => setIsMenuOpen(false)} className='block px-4 py-2 text-gray-700 hover:bg-gray-100 transition-colors duration-200'>Features</a>
            <a href="#workflow" onClick={() => setIsMenuOpen(false)} className='block px-4 py-2 text-gray-700 hover:bg-gray-100 transition-colors duration-200'>How It Works</a>
            <a href="#testimonials" onClick={() => setIsMenuOpen(false)} className='block px-4 py-2 text-gray-700 hover:bg-gray-100 transition-colors duration-200'>Testimonials</a>
            <a href="#faqs" onClick={() => setIsMenuOpen(false)} className='block px-4 py-2 text-gray-700 hover:bg-gray-100 transition-colors duration-200'>FAQs</a>
          </div>
          {isAuthenticated ? (
          <>
