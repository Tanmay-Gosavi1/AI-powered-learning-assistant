const Button = ({
    ...
    const variantStyles = {
        primary : 'bg-linear-to-r from-emerald-600 via-emerald-500 to-emerald-400 text-white hover:from-emerald-500 hover:via-emerald-400 shadow-lg shadow-emarald-500/25  hover:to-emerald-500 focus:ring-emerald-300',
