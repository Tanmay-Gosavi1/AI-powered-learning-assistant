...
const Modal = ({isOpen , onClose , title ,children}) => {
  ...
  return (
    <div className='fixed inset-0 z-50 flex items-center justify-center overflow-hidden'>
        ...
        {/* Modal Content */}
        <div className='relative w-full max-w-xl mx-4 bg-white/95 backdrop-blur-xl border-2 border-slate-200/60 rounded-2xl shadow-xl shadow-slate-500/60 p-8 animate-in z-10 fade-in slide-in-from-bottom-4 duration-300 flex flex-col gap-4'>
