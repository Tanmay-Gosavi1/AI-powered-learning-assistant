    ...
    <div className="group relative p-5 bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl transition-all duration-300 flex flex-col justify-between cursor-pointer hover:-translate-y-1" onClick={handleNavigate}>
        <div>
            <div className='flex items-start justify-between gap-3 mb-4'>
                ...
                <button 
                    ...
                    className='opacity-0 group-hover:opacity-100 w-8 h-8 cursor-pointer flex items-center justify-center rounded-md text-slate-400 hover:text-red-600 hover:bg-red-50 transition-all duration-200'    >
            ...
            <div className='flex items-center gap-2 text-xs text-slate-900 mb-3'>
            ...
            <div className='flex items-center gap-3'>
                {document.flashcardCount !== undefined && (
                    <div className='flex items-center gap-1.5 px-2.5 py-1.5 bg-purple-50 rounded-xl whitespace-nowrap'>
        ...
        <div className='mt-5 pt-4 border-t border-slate-100 '>
            <div className='flex items-center gap-1.5 text-xs text-slate-500 '>
                ...
                <span>Uploaded {moment(document.uploadedAt).fromNow()}</span>
            </div>
        </div>
